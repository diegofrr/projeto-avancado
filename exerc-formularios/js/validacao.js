...
const mensagensDeErro = {
    ...
    instagram: {
        valueMissing: 'O campo do Instagram não pode estar vazio.',
        patternMismatch: 'Username inválido.'
    },

    telefone: {
        valueMissing: 'O campo de telefone não pode estar vazio.',
        patternMismatch: 'O telefone precisa ter 11 dígitos.',
        customError: 'DDD inválido.',
    },
    nomeProduto: {
        valueMissing: 'O campo de nome do produto não pode estar vazio.',
        customError: 'O nome do produto precisa ter, pelo menos, 5 caracteres.'
    },
    descricao: {
        valueMissing: 'O campo de descrição não pode estar vazio.',
        customError: 'A descrição do produto precisa ter, pelos menos, 10 caracteres.'
    }
}
...
const validadores = {
    ...
    descricao: input => verificaDescricao(input)
}
...
function verificaDescricao(input) {
    let mensagem = ''
